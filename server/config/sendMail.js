  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
              ...
              <h2 style="text-align: center; text-transform: uppercase;color: black;">Welcome to Camera Shop</h2>
              <p>Congratulations! You're almost set to start using QuickShop.
                  Just click the button below to validate your email address.
              </p>
              
              <a href=${url} style="background: #f1510a; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${txt}</a>
